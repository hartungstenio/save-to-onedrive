(function () {
	if (!window.WL) {
		...
		(FILEDIALOG_PARAM_SELECT_SINGLE = "single", (FILEDIALOG_PARAM_SELECT_MULTI = "multi", (FILEDIALOG_PARAM_PERMISSION = "permission", (FILEDIALOG_PARAM_PERMISSION_ONETIME = "onetime", (FILEDIALOG_PARAM_LIGHTBOX = "lightbox", (FILEDIALOG_PARAM_LIGHTBOX_GREY = "grey", (FILEDIALOG_PARAM_LIGHTBOX_TRANSPARENT = "transparent", (FILEDIALOG_PARAM_LIGHTBOX_WHITE = "white", (FILEDIALOG_PARAM_LOADING_TIMEOUT = "loading_timeout", FILEDIALOG_PARAM_ONSELECTED = "onselected")))))))));
		var Mf = "auth",
		cf = "rps",
		We = "oauth",
		df = "v",
		...
		Jc.prototype = {
			...
			onClick : function () {
				...
				if (a._session.isSignedIn()) {
					...
					a.login(b._properties, true).then(function () {}, function (a) {
						b.fireEvent(mb, a)
					});
				return false
			},
		...
		function uc(a, b, i, g) {
			...
			d,
			c,
			f = "background: url({imgpath}/signincontrol/{image}.png) scroll {repeat} 0px {vpos}; height: 22px; width: {width};";
			switch (g) {
			case "left":
		...
		a._locale = "en";
		a[O] = "Web/DEVICE_" + Jf("5.5.8220.3001");
